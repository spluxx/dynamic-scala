...
trait FoldExtension {
  ...
  case object Stop extends Control[Nothing]
  ...
  case class Suspend2[T1, T2](private val t1: T1, private val t2: T2) extends Suspend {
    ...
    def loop[U](f: (T1, T2) => Control[(T1, T2)]): (T1, T2) = recurse(t1, t2)(f.tupled)
  }
  ...
  case class Suspend3[T1, T2, T3](private val t1: T1, private val t2: T2, private val t3: T3) extends Suspend {
    ...
    def loop[U](f: (T1, T2, T3) => Control[(T1, T2, T3)]): (T1, T2, T3) = recurse(t1, t2, t3)(f.tupled)
  }
  ...
  case class Suspend4[T1, T2, T3, T4](private val t1: T1, private val t2: T2, private val t3: T3, private val t4: T4) extends Suspend {
    ...
    def loop[U](f: (T1, T2, T3, T4) => Control[(T1, T2, T3, T4)]): (T1, T2, T3, T4) = recurse(t1, t2, t3, t4)(f.tupled)
  }
  ...
  case class Suspend5[T1, T2, T3, T4, T5](private val t1: T1, private val t2: T2, private val t3: T3, private val t4: T4, private val t5: T5) extends Suspend {
    ...
    def loop[U](f: (T1, T2, T3, T4, T5) => Control[(T1, T2, T3, T4, T5)]): (T1, T2, T3, T4, T5) = recurse(t1, t2, t3, t4, t5)(f.tupled)
  }
}
